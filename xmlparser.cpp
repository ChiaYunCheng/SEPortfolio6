...
namespace XML_Parser
{
  ...
  string extractContentFromElement(const string & source, const string & elementName)
  {
	  return getElementContent(getElement(source, elementName));
  }

  string extractContentAndErase(string & source, const string & elementName)
  {
	  return getElementContent(getAndEraseElement(source, elementName));
  }
}
